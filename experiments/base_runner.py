...
DEFAULT_JELLY_CONFIG = JELLYConfig()
...
class BaseExperimentRunner(ABC):
    ...
    def __init__(
        ...
        self.jelly_config = jelly_config or DEFAULT_JELLY_CONFIG
    ...
    def save_metadata(self, extra_info: dict = None):
        ...
        metadata = {
            ...
            "jelly_config": asdict(self.jelly_config),
        }
        if extra_info:
...
# 비교 메소드 목록
# ============================================================
COMPARISON_METHODS = ["bitfit", "lora", "adalora", "dora", "pissa", "jelly"]
